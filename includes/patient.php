...
class Patient extends DatabaseObject{
    ...
    //-------------------------
    public static function set_patient_table(){
        $db_feilds =  array('patientFirst','patientLast', 'chartNum','dateOfBirth','sex','zipCodeHome','zipCodeWork','dateAdded','email','tester');
        parent::set_table_fields("patient",$db_feilds);
     }
    ...
    public function create(){
        ...
        if ($database->query($sql)){
            $this->patientID = $database->insert_id();
            return true;
        }else{
            return false;
        }
