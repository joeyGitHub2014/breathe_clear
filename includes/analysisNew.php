...
class Analysis extends DatabaseObject{
    ...
    //parent::set_table_name("photograph");
    //parent::db_fields(array('id','filename','type', 'size','caption'));

    //parent:: static $table_name = "users";
    //parent::$db_fields = array('id','filename','type', 'size','caption');
    public $analysisID;
    ...
    public function set_table_fields(){
        $db_feilds =  array('analysisID','analysisCount','patientID','allergenID','MSPScore','ITScore','validated','dateAdded',
			    'treatment','twoWhl','dilutionLevel','refill');
	...
	//------------------------------
	public function get_max_analysis_count($id){
	    global $database;
	...
	//------------------------------
	public function get_analysis_date($id, $count){
	    global $database;
	...
	//------------------------------
	public function get_treatment($id, $count){
	    global $database;
	...
	//------------------------------
	public function get_dilutionLevel($id, $count){
	    global $database;
	...
	//function get_refill
	//------------------------------
	public function get_refill($id, $count){
	    global $database;
